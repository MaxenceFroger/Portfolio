...
(
    ...
    CONSTRAINT check_date CHECK (
        (figurine_est_possedee IS TRUE AND figurine_date_acquisition IS NOT NULL)
            OR (figurine_est_possedee IS FALSE)
        ),
        CONSTRAINT check_date2 CHECK (
        (figurine_est_possedee IS TRUE AND figurine_date_acquisition IS NOT NULL)
        OR (figurine_est_possedee IS FALSE AND figurine_date_acquisition IS NULL)
        )
);
...
VALUES
    (889698546966, 170.0, false, false, NULL),
    ...
    (849803071523, 110.0, false, false, NULL),
    ...
    (889698702720, 24.0, false, false, NULL),
    ...
    (889698572781, 154.0, false, false, NULL),
    ...
    (889698540438, 141.0, false, false, NULL),
    (849803075255, 62.0, false, false, NULL),
    (889698274487, 125.0, false, false, NULL),
